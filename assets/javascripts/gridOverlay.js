...
;(function() {
  ...
  var options = {
    'maxPageWidth' :     '2000px',                       // set overlay width to match page width (as max-width for flexible grids)
    'columnWidth' :      '60px',                        // set column width in px, em or %
    'columnCount' :       0,                           // set column count
    'columnColor' :      'rgba(255, 0, 0, 0.25)',       // set column color
    'gutterWidth' :      '20px',                        // set gutter width in px, em or %
    'baselineHeight' :    9,                           // set baseline height (requires pixels for now)
